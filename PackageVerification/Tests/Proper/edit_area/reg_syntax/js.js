	...
	,'KEYWORDS' : {
		'statements' : [
 		...
 		,'keywords' : [
            ...
            , "System", "Web", "UI", "WebControls", "Page", "Response", "Server", "Request", "IO", "ModuleController", "DataContext", "Parent"
            , "Twitter", "UpdatePanel", "this", "User", "UserInfo"
		]
    	,'functions' : [
			...
			'stop', "ExecuteSql", "GetSqlValue", "RawWrite", "echo", "css", "style", "js", "path", "ReadFile", "RenderFile", "form"
            , "get", "q", "isNull", "cacheGet", "cacheAdd", "cacheRemove", "load", "loadfrom", "trace"
		]
	}
	,'OPERATORS' :[
		'+', '-', '/', '*', '=', '<', '>', '%', '!'
